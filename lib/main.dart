  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/chatRoom': (context) => const Placeholder(), // Placeholder, handled below
...
// =================================================================
// >>> 2. AUTHENTICATION SCREENS & HELPERS
// =================================================================
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                GestureDetector(
                  onTap: () => debugPrint('Open image picker for group icon'),
                  child: Container(
                    width: 50, height: 50,
...
class _OtpScreen extends StatefulWidget {
  final String fullPhoneNumber;
  const _OtpScreen({super.key, required this.fullPhoneNumber});
  @override
  State<OtpScreen> createState() => _OtpScreenState();
}
...
class _RegisterOtpScreen extends StatefulWidget {
  final String fullPhoneNumber;
  const _RegisterOtpScreen({super.key, required this.fullPhoneNumber});
  @override
  State<RegisterOtpScreen> createState() => _RegisterOtpScreenState();
}
...
class _ProfileSetupScreen extends StatefulWidget {
  const _ProfileSetupScreen({super.key});
  @override
  State<ProfileSetupScreen> createState() => _ProfileSetupScreenState();
}
...
class _PinSecurityScreen extends StatefulWidget {
  const _PinSecurityScreen({super.key});

  @override
  State<PinSecurityScreen> createState() => _PinSecurityScreenState();
}

enum _PinState { setup, confirm }

class PinSecurityScreenState extends State<PinSecurityScreen> {
  final int _pinLength = 4;
  String _currentPin = '';
  PinState _state = PinState.setup;
  String _initialPin = '';
...
class _ChatRoomScreen extends StatefulWidget {
  final ChatDataModel chat;
  const _ChatRoomScreen({super.key, required this.chat});
  @override
  State<ChatRoomScreen> createState() => _ChatRoomScreenState();
}
...
class _NewGroupScreen extends StatefulWidget {
  const _NewGroupScreen({super.key});
